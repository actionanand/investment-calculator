...
```bash
git clone https://github.com/actionanand/investment-calculator.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/investment-calculator#1-skeleton angular-proj-name
```
